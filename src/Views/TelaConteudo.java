 ...
 * @author Sábia
 */
public class TelaConteudo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/telaconteudos.png"))); // NOI18N
    ...
    private void lb_escolhacinematicaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lb_escolhacinematicaMouseClicked
        try {
            Runtime.getRuntime().exec("cmd.exe /C start " + "../e-fisico\\src\\Arquivos\\CINEMÁTICA.pdf");
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        try {
            Runtime.getRuntime().exec("cmd.exe /C start " + "../e-fisico\\src\\Arquivos\\DINÂMICA.pdf");
        } catch (IOException ex) {
            System.out.println(ex.getMessage());
        }
        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConteudo().setVisible(true);
            }
        });
    }
