 ...
 * @author Sábia
 */
public class TelaCalculo3LeiNewton1 extends javax.swing.JFrame {

    CalculoVelocidadeClass calculoVelocidadeClass = new CalculoVelocidadeClass();
    DecimalFormat decimal = new DecimalFormat("0.00");

    public TelaCalculo3LeiNewton1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/Terceira Lei de Newton.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/8.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCalculo3LeiNewton1().setVisible(true);
            }
        });
    }
