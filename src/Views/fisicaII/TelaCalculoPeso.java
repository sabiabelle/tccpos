 ...
 * @author Sábia
 */
public class TelaCalculoPeso extends javax.swing.JFrame {

    CalculoDinamicaClass calculoDinamicaClass = new CalculoDinamicaClass();
    DecimalFormat decimal = new DecimalFormat("0.00");

    public TelaCalculoPeso() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/9.png"))); // NOI18N
        ...
        tf_aceleracao.setToolTipText("Gravidade");
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/4 formula.png"))); // NOI18N
    ...
    public void calculo() {
        ...
        if (rd_forca.isSelected()) {
            if (!tf_aceleracao.getText().isEmpty() && !tf_massa.getText().isEmpty()) {
                ...
                lb_result1.setText("P = " + m + " * " + a);
                lb_resultFinal.setText("P: " + resposta + " N");
            } else {
        ...
        if (rd_aceleracao.isSelected()) {
            if (!tf_forca.getText().isEmpty() && !tf_massa.getText().isEmpty()) {
                ...
                lb_result1.setText("G = " + f + " / " + m);
                lb_resultFinal.setText("G = " + resposta);
            } else {
