 ...
 * @author Sábia
 */
public class TelaCalculoHooke extends javax.swing.JFrame {

    CalculoDinamicaClass calculoDinamicaClass = new CalculoDinamicaClass();
    DecimalFormat decimal = new DecimalFormat("0.00");

    public TelaCalculoHooke() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/12.png"))); // NOI18N
        ...
        rd_massa.setText("Constante Elástica");
        ...
        rd_aceleracao.setText("Variação da Deformação");
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(lb_resultFinal, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/7 formula.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel6, javax.swing.GroupLayout.PREFERRED_SIZE, 1300, Short.MAX_VALUE)
        );
    ...
    private void rd_aceleracaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rd_aceleracaoMouseClicked
        limpar();
        lb_result.setText("G = P / M");
        lb_result1.setText("G = ");
        lb_resultFinal.setText("G = ");
        rd_massa.setSelected(false);
        rd_forca.setSelected(false);
    ...
    public void calculo() {
        ...
        if (rd_massa.isSelected()) {
            ...
            if (!tf_aceleracao.getText().isEmpty() && !tf_forca.getText().isEmpty()) {
                ...
                lb_result1.setText("K = " + f + " / " + a);
                lb_resultFinal.setText("K = " + resposta);
        ...
        if (rd_aceleracao.isSelected()) {
            if (!tf_forca.getText().isEmpty() && !tf_massa.getText().isEmpty()) {
                ...
                lb_result1.setText("L = " + f + " / " + m);
                lb_resultFinal.setText("L = " + resposta);
            } else {
