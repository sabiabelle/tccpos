 ...
 * @author Sábia
 */
public class TelaCalculo2LeiNewton extends javax.swing.JFrame {

    CalculoDinamicaClass calculoDinamicaClass = new CalculoDinamicaClass();
    DecimalFormat decimal = new DecimalFormat("0.00");

    public TelaCalculo2LeiNewton() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/7.png"))); // NOI18N
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(lb_resultFinal, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lb_result1, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lb_result, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/3 formula.png"))); // NOI18N
    ...
    private void rd_massaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rd_massaMouseClicked
        limpar();
        lb_result.setText("M = F/A");
        lb_result1.setText("M = ");
        lb_resultFinal.setText("M = ");
        rd_aceleracao.setSelected(false);
    ...
    private void rd_aceleracaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rd_aceleracaoMouseClicked
        limpar();
        lb_result.setText("A = F / M");
        lb_result1.setText("A = ");
        lb_resultFinal.setText("A = ");
        rd_massa.setSelected(false);
        rd_forca.setSelected(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCalculo2LeiNewton().setVisible(true);
            }
        });
    }
    ...
    public void calculo() {
        ...
        if(rd_massa.isSelected()){
            ...
            if(!tf_aceleracao.getText().isEmpty() && !tf_forca.getText().isEmpty()){
                ...
                lb_result1.setText("M = " + f + " / " + a );
                lb_resultFinal.setText("M = " + resposta);
        ...
        if(rd_aceleracao.isSelected()){
            if(!tf_forca.getText().isEmpty() && !tf_massa.getText().isEmpty()){
                ...
                lb_result1.setText("A = " + f + " / " + m);
                lb_resultFinal.setText("A = " + resposta);
            }else{
