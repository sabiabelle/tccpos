 ...
 * @author Sábia
 */
public class TelaCalculoEquacaoTorricelli extends javax.swing.JFrame {

    DecimalFormat decimal = new DecimalFormat("0.00");
    CalculoVelocidadeClass calculoVelocidadeClass = new CalculoVelocidadeClass();

    public TelaCalculoEquacaoTorricelli() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tf_aceleracao, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 265, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        lb_resultado.setText("V² =  V0²  +  2  .  a  .  ∆D");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lb_resultado, javax.swing.GroupLayout.DEFAULT_SIZE, 426, Short.MAX_VALUE)
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/F7.png"))); // NOI18N
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/formulas.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCalculoEquacaoTorricelli().setVisible(true);
            }
        });
    }
    ...
    public void calculo() {
        if (rd_aceleracao.isSelected()) {
            if (!tf_velocidadefinal.getText().isEmpty() && !tf_velocidadeinicial.getText().isEmpty()
                ...
                lb_resultado.setText("ãm = (V² - V0²) / (S . 2)");
                lb_resultado2.setText("ãm = (" + e + "² - " + f + "²) / (" + d + " . 2 )");
                lb_resultado3.setText("ãm = (" + h + " - " + j + ") / " + n);
                lb_resultado4.setText("ãm = " + l + " / " + n);
                lb_resultado6.setVisible(false);
                lb_resultado7.setVisible(false);
                lb_resultado8.setVisible(false);
                if (rd_km.isSelected()) {
                    if (rd_s.isSelected()) {
                        lb_resultado5.setText("ãm =  " + p + " Km/s");
                    }
                    if (rd_min.isSelected()) {
                        lb_resultado5.setText("ãm =  " + p + " Km/min");
                    }
                    if (rd_h.isSelected()) {
                        lb_resultado5.setText("ãm =  " + p + " Km/h");
                    }
                }
                if (rd_m.isSelected()) {
                    if (rd_s.isSelected()) {
                        lb_resultado5.setText("ãm =  " + p + " m/s");;
                    }
                    if (rd_min.isSelected()) {
                        lb_resultado5.setText("ãm =  " + p + " m/min");
                    }
                    if (rd_h.isSelected()) {
                        lb_resultado5.setText("ãm =  " + p + " m/h");
                    }
                }
                if (rd_cm.isSelected()) {
                    if (rd_s.isSelected()) {
                        lb_resultado5.setText("ãm =  " + p + " cm/s");
                    }
                    if (rd_min.isSelected()) {
                        lb_resultado5.setText("ãm =  " + p + " cm/min");
                    }
                    if (rd_h.isSelected()) {
                        lb_resultado5.setText("ãm =  " + p + " cm/h");
                    }
                }
            ...
            if (!tf_aceleracao.getText().isEmpty() && !tf_velocidadeinicial.getText().isEmpty()
                ...
                Double o = calculoVelocidadeClass.aux3(k, m); //divisão
                String p = decimal.format(o);
                lb_resultado.setText("S = (V² - V0²) / (2 . ãm)");
                lb_resultado2.setText("S = (" + e + "² - " + f + "²) / ( 2 . " + d + ")");
                lb_resultado3.setText("S = (" + h + " - " + j + ") / " + n);
                lb_resultado4.setText("S = " + l + " / " + n);
                lb_resultado6.setVisible(false);
                lb_resultado7.setVisible(false);
                lb_resultado8.setVisible(false);
                if (rd_km.isSelected()) {
                    if (rd_s.isSelected()) {
                        lb_resultado5.setText("S =  " + p + " Km/s");
                    }
                    if (rd_min.isSelected()) {
                        lb_resultado5.setText("S =  " + p + " Km/min");
                    }
                    if (rd_h.isSelected()) {
                        lb_resultado5.setText("S =  " + p + " Km/h");
                    }
                }
                if (rd_m.isSelected()) {
                    if (rd_s.isSelected()) {
                        lb_resultado5.setText("S =  " + p + " m/s");;
                    }
                    if (rd_min.isSelected()) {
                        lb_resultado5.setText("S =  " + p + " m/min");
                    }
                    if (rd_h.isSelected()) {
                        lb_resultado5.setText("S =  " + p + " m/h");
                    }
                }
                if (rd_cm.isSelected()) {
                    if (rd_s.isSelected()) {
                        lb_resultado5.setText("S =  " + p + " cm/s");
                    }
                    if (rd_min.isSelected()) {
                        lb_resultado5.setText("S =  " + p + " cm/min");
                    }
                    if (rd_h.isSelected()) {
                        lb_resultado5.setText("S =  " + p + " cm/h");
                    }
                }
            } else {
                JOptionPane.showMessageDialog(rootPane, "Preencha os campos: aceleração, tempo inicial e final");
            ...
            if (!tf_aceleracao.getText().isEmpty() && !tf_espaco.getText().isEmpty()
                ...
                lb_resultado.setText("V0 = √ (V² - 2 . ãm . S)");
            ...
            if (!tf_aceleracao.getText().isEmpty() && !tf_velocidadeinicial.getText().isEmpty()
                ...
                Double q = Math.sqrt(m); //calculando a raiz 
                String r = decimal.format(q);
                lb_resultado.setText("V = √ ( V0² + 2 . ãm . Δd )");
    ...
    public void limpar() {
        ...
        if (rd_aceleracao.isSelected()) {
            ...
            lb_resultado.setText("V² = Vo²   +  2   .  ãm .  ΔD");
            lb_resultado2.setText("V² =  ");
            lb_resultado3.setText("V²=  ");
            lb_resultado4.setText("V² =  ");
            lb_resultado5.setText("V² =  ");
